...
<div class="h-full flex min-h-screen bg-white">
    ...
    <div class="md:w-1/2 max-w-lg mx-auto px-4 py-5 shadow-none">
        <div class="pb-2 pt-4 mb-0 font-semibold text-center bg-white border-b-0 rounded-t-2xl">
            <h5>Register with</h5>
            <div class="flex flex-wrap px-3 mt-2 -mx-3 sm:px-6 xl:px-12">
                <div class="text-center w-2/12 max-w-full px-1 ml-auto flex-0">
                    <a class="flex justify-center items-center inline-block w-full px-5 py-2 mb-4 font-bold text-center text-gray-200 uppercase align-middle transition-all bg-transparent border border-gray-200 border-solid rounded-lg shadow-none cursor-pointer hover:-translate-y-px leading-pro text-xs ease-in tracking-tight-rem bg-150 bg-x-25 hover:bg-transparent hover:opacity-75"
                       href="javascript:;">
                ...
                {{--                <div class="w-2/12 max-w-full px-1 flex-0">--}}
                {{--                    <a class="flex justify-center items-center inline-block w-full px-5 py-2 mb-4 font-bold text-center text-gray-200 uppercase align-middle transition-all bg-transparent border border-gray-200 border-solid rounded-lg shadow-none cursor-pointer hover:-translate-y-px leading-pro text-xs ease-in tracking-tight-rem bg-150 bg-x-25 hover:bg-transparent hover:opacity-75"--}}
                {{--                       href="javascript:;">--}}
                {{--                        <svg width="24px" height="32px" viewBox="0 0 64 64" version="1.1"--}}
                ...
                {{--                    </a>--}}
                {{--                </div>--}}
                <div class="w-2/12 max-w-full px-1 mr-auto flex-0">
                    <a class="flex justify-center items-center inline-block w-full px-5 py-2 mb-4 font-bold text-center text-gray-200 uppercase align-middle transition-all bg-transparent border border-gray-200 border-solid rounded-lg shadow-none cursor-pointer hover:-translate-y-px leading-pro text-xs ease-in tracking-tight-rem bg-150 bg-x-25 hover:bg-transparent hover:opacity-75"
                       href="javascript:;">
                        <svg width="24px" height="32px" viewBox="0 0 64 64" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <div class="relative flex flex-col w-full max-w-full px-3 text-center shrink-0">
        ...
        <div class="w-3/4 mx-auto mt-2 flex-auto border rounded-lg border-gray-400">
