    ...
    <main class=" flex-1 py-10  px-5 sm:px-10 ">
        ...
        <section class="mt-9">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2 fill-gray-500">
                    <svg class="h-7 w-7 rounded-full border p-1 hover:border-red-600 hover:fill-red-600 dark:fill-white dark:hover:fill-red-600"
                    ...
                    <div class="relative rounded-xl overflow-hidden category"> <!-- Ajoutez la classe category ici -->
                        ...
                        <div class="absolute top-0 h-full w-full p-3 flex flex-col justify-between">
                            ...
                            <div class="self-center flex flex-col items-center space-y-2">
                                <span class="capitalize text-white font-medium drop-shadow-md">{{$category->name}}</span>
                            </div>
                        </div>
                    </div>
                @endforeach
        ...
        <section class="mt-9">
            <div class="flex items-center justify-between">
                ...
                <span class="font-semibold text-gray-700 text-base dark:text-white">View all</span>
            </div>
